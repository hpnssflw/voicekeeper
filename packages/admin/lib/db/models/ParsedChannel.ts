...
export const ParsedChannelModel = models.parsed_channels || model('parsed_channels', ParsedChannelSchema);
...
export const ParsedPostModel = models.parsed_posts || model('parsed_posts', ParsedPostSchema);
